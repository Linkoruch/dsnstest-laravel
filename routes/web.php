 ...
 *
 * ✅ DONE - Створити ролі користувачів (admin, student)
 * ✅ DONE - Створити модель + міграцію + CRUD для тестів (назва, опис, шлях до json файлу з питаннями)
 * TODO - Створити модель + міграцію + CRUD для результатів тестів (який користувач, який тест, шлях до json файлу result, дата)
 * TODO - Тип файлу з питаннями має бути у форматі {
 *    "questions": [
 ...
 *     ...
 *   ]}
 * TODO - Тип файлу відповіді має бути у форматі {
 *     "correct_answers": 7,
 *     "total_questions": 10,
 *     "answers": [
 ...
 *   ]}
 * }
 * TODO - Переробтити dashboard на список всіх тестів з можливістю пошуку
 * TODO - Додати можливість для адміністратора створювати, редагувати, видаляти тести
 *  - Це має бути Окремий шлях в роутах /tests
 *  - Також це має бути окремий Livewire компонент
 *  - Для редагування тессту треба клікнути на значок олівця біля тесту
